...
#create a new variable to convert the internal units (square feet) to an alternative unit (square feet)
total_meters = UnitUtils.ConvertFromInternalUnits(total_area, UnitTypeId.SquareMeters)
...
text = 'The total area of rooms in the building is \n\n{x} square meters \n\n{y} square feet'.format(x = round(total_meters, 1), y = round(total_area, 1))
